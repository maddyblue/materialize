...
#[derive(Debug, Clone, PartialEq, Eq, Hash, EnumKind, ToDoc)]
...
impl_to_doc_t!(KafkaBrokerTunnel);
...
impl_to_doc_t!(CreateIndexStatement);
...
impl_to_doc_t!(ShowStatementFilter);
...
impl_to_doc!(AlterSystemResetAllStatement);
