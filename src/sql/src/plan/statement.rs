...
pub fn describe(
    ...
    let desc = match stmt {
        ...
        Statement::AlterType(stmt) => ddl::describe_alter_type(&scx, stmt)?,
        Statement::AlterAddPrimaryKey(stmt) => ddl::describe_alter_add_primary_key(&scx, stmt)?,
        Statement::AlterAddColumn(stmt) => ddl::describe_alter_add_column(&scx, stmt)?,
        Statement::AlterDropColumn(stmt) => ddl::describe_alter_drop_column(&scx, stmt)?,
        Statement::AlterObjectRename(stmt) => ddl::describe_alter_object_rename(&scx, stmt)?,
        Statement::AlterColumnRename(stmt) => ddl::describe_alter_column_rename(&scx, stmt)?,
...
pub fn plan(
    ...
    let plan = match stmt {
        ...
        Statement::AlterType(stmt) => ddl::plan_alter_type(scx, stmt),
        Statement::AlterAddPrimaryKey(stmt) => ddl::plan_alter_add_primary_key(scx, stmt),
        Statement::AlterAddColumn(stmt) => ddl::plan_alter_add_column(scx, stmt),
        Statement::AlterDropColumn(stmt) => ddl::plan_alter_drop_column(scx, stmt),
        Statement::AlterObjectRename(stmt) => ddl::plan_alter_object_rename(scx, stmt),
        Statement::AlterColumnRename(stmt) => ddl::plan_alter_column_rename(scx, stmt),
