...
//! Renders the table snapshot side of the [`MssqlSourceConnection`] ingestion dataflow.
//!
//! # Snapshot reading
//!
...
//! necessarily exist for a normal SQL transaction. To achieve this we must force mssql to
...
//! pre-created.
//!
//! [mssql thread]: https://www.mssqlql.org/message-id/flat/CAMN0T-vzzNy6TV1Jvh4xzNQdAvCLBQK_kh6_U7kAXgGU3ZFg-Q%40mail.gmail.com
//!
...
//! "export transaction" feature of mssql. This feature allows one SQL session to create an
...
//! LSN, it could be an LSN in the future chosen by MssqlSQL while it creates the temporary
//! replication slot.
//!
...
use crate::source::mssql::replication::RewindRequest;
use crate::source::mssql::{simple_query_opt, verify_schema, DefiniteError, TransientError};
